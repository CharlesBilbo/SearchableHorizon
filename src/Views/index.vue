...
export default {
  ...
  methods: {
    ...
    loadJobs(starting = -1, refreshing = false) {
      ...
      this.$http.get(Horizon.basePath + '/api/jobs/' + this.$route.params.type + '?starting_at=' + starting + '&limit=' + this.perPage + '&query=' + this.tagSearchPhrase)
          .then(response => {
    ...
    <div class="card overflow-hidden">
      <div class="card-header d-flex align-items-center justify-content-between">
        ...
        <div class="form-control-with-icon">
          ...
          <input type="text" class="form-control w-100" v-model="tagSearchPhrase" placeholder="Search Jobs">
        </div>
      </div>
